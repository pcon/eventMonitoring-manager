...
const typeMap = require('../../../../lib/utils/transformers/typeMap');
...
describe('Type Map', function () {
    test('Valid mapping', function () {
        ...
        return typeMap(event_log_file, events).then(function (results) {
    ...
    test('Invalid mapping', function () {
        ...
        return typeMap(event_log_file, events).catch(function (err) {
